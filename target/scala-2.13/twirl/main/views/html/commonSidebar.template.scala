...
<ul>
  <li><a href=""""),_display_(/*5.17*/routes/*5.23*/.BookController.index),format.raw/*5.44*/("""#Introduction">Welcome</a>
  <li><a href=""""),_display_(/*6.17*/routes/*6.23*/.BookController.explore),format.raw/*6.46*/("""">Play application overview</a>
  <li><a href=""""),_display_(/*7.17*/routes/*7.23*/.BookController.tutorial),format.raw/*7.47*/("""">Implementing Hello World</a>
</ul>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: f6692eb5baf2024cbd50136392b63b4cf9ca602a
